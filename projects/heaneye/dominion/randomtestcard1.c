...
int main()
{
	...
	clock_t begin = clock();
     ...
     for (k = 0; k < TEST_COUNT; k++) {
          ...
          printf("\tplayer 0 hand count = %d, expected = %d\n", testGame.handCount[thisPlayer], preConditionState.handCount[thisPlayer]+3);
          ...
          printf("\tplayer 0 deck count = %d, expected = %d\n", testGame.deckCount[thisPlayer], preConditionState.deckCount[thisPlayer]-2);
          if (testGame.deckCount[thisPlayer] == preConditionState.deckCount[thisPlayer]-3) {
               printf("\tPASS\n");
               passCount++;
          }
          else {
