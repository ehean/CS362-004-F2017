...
int main()
{
     ...
     for (k = 0; k < TEST_COUNT; k++) {
          ...
          for (i = 0; i < testGame.numPlayers; i++) {
               ...
               // MAKE SURE ADVENTURER IS IN EVERY PLAYER'S HAND
          ...
          printf("\tplayer 0 discard count = %d, expected = %d\n", testGame.discardCount[thisPlayer], preConditionState.discardCount[thisPlayer]);
          if (testGame.discardCount[thisPlayer] == preConditionState.discardCount[thisPlayer]) {
               printf("\tPASS\n");
               passCount++;
          }
          else {
          ...
          printf("\tplayer 0 discard+deck count = %d, expected = %d\n", testGame.discardCount[thisPlayer]+testGame.deckCount[thisPlayer], preConditionState.discardCount[thisPlayer] + preConditionState.deckCount[thisPlayer]);
          if (testGame.discardCount[thisPlayer]+testGame.deckCount[thisPlayer] == preConditionState.discardCount[thisPlayer] + preConditionState.deckCount[thisPlayer]) {
               printf("\tPASS\n");
               passCount++;
          }
          else {
          ...
          printf("TEST 3:\n\tDeck+Discard Count, post-effect\n");

               printf("\tplayer 0 deck+discard count = %d, expected = %d\n", testGame.deckCount[thisPlayer] + testGame.discardCount[thisPlayer], preConditionState.deckCount[thisPlayer] + preConditionState.discardCount[thisPlayer]);
               if (testGame.deckCount[thisPlayer] + testGame.discardCount[thisPlayer] == preConditionState.deckCount[thisPlayer] + preConditionState.discardCount[thisPlayer]) {
                    printf("\tPASS\n");
                    passCount++;
               }
               else {
               ...
               printf("\tplayer 0 hand count = %d, expected = %d\n", testGame.handCount[thisPlayer], preConditionState.handCount[thisPlayer]+2);
               if (testGame.handCount[thisPlayer] == preConditionState.handCount[thisPlayer]+2) {
                    printf("\tPASS\n");
                    passCount++;
               }
               else {
               ...
               printf("\tplayer 0 deck+discard count = %d, expected = %d\n", testGame.deckCount[thisPlayer] + testGame.discardCount[thisPlayer], preConditionState.deckCount[thisPlayer] + preConditionState.discardCount[thisPlayer]-2);
               if (testGame.deckCount[thisPlayer] + testGame.discardCount[thisPlayer] == preConditionState.deckCount[thisPlayer] + preConditionState.discardCount[thisPlayer]-2) {
                    printf("\tPASS\n");
                    passCount++;
               }
               else {
